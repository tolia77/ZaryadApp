...
namespace ZaryadApp.Migrations
{
    ...
    [Migration("20230527101654_remove settings name")]
    partial class removesettingsname
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ZaryadApp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ZaryadApp.Models.Review", b =>
                {
                    b.HasOne("ZaryadApp.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Review")
                        .HasForeignKey("ZaryadApp.Models.Review", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
