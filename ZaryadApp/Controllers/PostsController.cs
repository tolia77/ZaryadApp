...
namespace ZaryadApp.Controllers
{
    public class PostsController : Controller
    {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Create([Bind("Id,Title,Text,CreatedAt")] Post post)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Text,CreatedAt")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
